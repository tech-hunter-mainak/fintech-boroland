<script lang="ts">
	...
	// ... (sidebarItems const is no longer needed here) ...

	// ... (handleLogout is no longer needed here, it's in Sidebar.svelte) ...
...
<!-- 
  CLEANUP: The entire <div class="-mt-20">, <div class="flex flex-wrap">, 
  and the fixed sidebar div has been REMOVED from this component.
  It now only renders the *content* for the main dashboard page.
  The sidebar is now handled by the layout file.
-->

<!-- 
  FIX: Removed `col-span-6`, `ml-20`, `lg:ml-52` and `mt-40 lg:mt-20`
  The layout file now handles all margins.
-->
<div class="w-auto bg-white pb-6 m-5 xl:flex gap-10">
	{#if isLoading}
		<div class="rounded-lg w-full bg-white p-8 text-center shadow-md">
	...
	{:else}
		<!-- Credit Score Status -->
		<div
			class="mb-8 xl:mb-0 w-fit max-w-[800px] transform rounded-lg bg-white p-8 shadow-md transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg"
		>
			<div class="mb-8">
