<div class="mx-auto mt-16 max-w-4xl px-5">
	<div class="text-center">
		<h2 class="text-3xl font-semibold">Features you'll love</h2>
	...
	<div class="mb-36 mt-10 grid gap-10 md:grid-cols-2">
		<div class="flex items-start gap-4">
			<span class="rounded-full bg-violet-500/10 p-3 text-violet-600">
				<svg
					width="15"
					height="15"
					viewBox="0 0 15 15"
			...
			<div>
				...
				<p class="mt-1 text-gray-500">
					You don't need to be an expert to customize this plugin. Our code is very readable and
					well documented.
				</p>
			</div>
		</div>
		...
		<div class="flex items-start gap-4">
			...
			>
			<div>
				<h3 class="text-xl font-semibold">Fully Responsive</h3>
				<p class="mt-1 text-gray-500">
		...
		<div class="flex items-start gap-4">
			...
			>
			<div>
				<h3 class="text-xl font-semibold">Developer Support</h3>
				<p class="mt-1 text-gray-500">
					Our plugins are supported by sponsors who provide community support. Sponsors will get
		...
		<div class="flex items-start gap-4">
			...
			>
			<div>
				<h3 class="text-xl font-semibold">Cross Browser</h3>
				<p class="mt-1 text-gray-500">
					We make sure our plugins are working perfectly with all modern browsers available such as
		...
		<div class="flex items-start gap-4">
			...
			<div>
				...
				<p class="mt-1 text-gray-500">
					We strictly follow a set of guidelines along with unit tests to make sure your
		...
		<div class="flex items-start gap-4">
			...
			>
			<div>
				<h3 class="text-xl font-semibold">Well Maintained</h3>
				<p class="mt-1 text-gray-500">
					This templatte is actively maintained by the core plugin team. We are working on fixing
