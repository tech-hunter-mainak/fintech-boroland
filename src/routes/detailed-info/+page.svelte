      ...
      try {
        ...
        const mlData = {
          data: [{
            ...
            "WHAT IS YOUR HIGHEST EDUCATIONAL QUALIFICATION?": formData.education === 'Graduate' || formData.education === 'Post Graduate' ? 'HSLC' : formData.education,
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-lg shadow-xl p-6 md:p-8">
      ...
      <form on:submit|preventDefault={handleSubmit} class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-medium text-gray-700">Are you the Primary Earner?</label>
            <select
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700">Relation with Primary Earner</label>
            <input
              type="text"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-medium text-gray-700">Do you have any certification?</label>
            <select
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-medium text-gray-700">Monthly Family Income (₹)</label>
            <input
              type="number"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700">Monthly Family Expenditure (₹)</label>
            <input
              type="number"
